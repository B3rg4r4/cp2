...
export default function PaginaUm() {
  return (
    <div>
      <h1>Catástrofes Cósmicas Recentes</h1>
      <p>
        Velikovsky argumenta que, em tempos históricos, a Terra foi afetada por eventos astronômicos catastróficos, como colisões e interações
